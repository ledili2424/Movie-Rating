...
function MovieDetails({ selectedId, onAddwatched, onClose, watched }) {
  ...
  function handleAdd() {
    if (watched.some((watchedMovie) => watchedMovie.imdbID === movie.imdbID)) {
      window.alert(`Movie "${title}" is already in your list!`);
    } else {
      ...
      window.alert(`Movie "${title}" added to your list!`);
    }
    onClose();
  }
